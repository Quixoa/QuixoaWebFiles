 ...
 */
define("DB_HOST", "quixoamemberdb.db.11820018.hostedresource.com");
define("DB_NAME", "quixoamemberdb");
define("DB_USER", "quixoamemberdb");
define("DB_PASS", "SuperSecure#1");
...
define("COOKIE_DOMAIN", ".quixoa.com");
define("COOKIE_SECRET_KEY", "1gp@T14126dsfasfBKASMPQZ{+$78#ASDFfpMJFe-92s");
...
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "quixoaconfirm@gmail.com");
define("EMAIL_SMTP_PASSWORD", "jjaaiinN1");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://quixoa.com/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "passwords@quixoa.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Quixoa Password Reset");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password Reset");
define("EMAIL_PASSWORDRESET_CONTENT", "Please click this link to reset your password:");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", "http://quixoa.com/register.php");
define("EMAIL_VERIFICATION_FROM", "EmailVerification@quixoa.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Quixoa Email Verification");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Quixoa.com");
